...
INIT = [
    ...
    """
      CREATE TABLE IF NOT EXISTS team_tactics(
         ...
         FOREING KEY (team_id) REFERENCES team(team_id) ON DELETE CASCADE ON UPDATE CASCADE
      )
      """
]
...
def fill_tables():
    ...
    df_team_tactics=pd.read_csv("./data/tbl_team_tactics.csv",usecols=["int_tactic_id","int_team_id","str_defensive_style","int_team_width","int_depth","str_offensive_style","int_width","int_players_in_box","int_corners","int_freekicks"])
